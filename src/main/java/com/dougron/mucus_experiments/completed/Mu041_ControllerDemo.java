...
/*
 * testing the receipt of controller information messages in Ableton Live
 * 
 * this adds random controller information to a Mu and the LocalOutputManager handles it
 * 
 * it is debatable whether MucusKernel shoudl be the catchall for all musical generation tools. 
 * could result in a monolithic class
 */
