...
class RandomDiatonicTriadProgression_Tests {
	...
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_and_no_access_to_required_parameter_plugins_then_getRenderedParameters_will_be_length_1() throws Exception {
	...
	@Test
	void when_passing_a_package_with_XMLKEY_and_no_access_to_required_parameter_plugins_then_getRenderedParameters_will_be_length_1() throws Exception {
...
//	}
	...
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_only_then_json_will_not_have_CHORD_LIST_GENERATOR_item() throws Exception {
		// because only the PHRASE_LENGTH will have rendered. CHORD_PROGRESSION will not render due to absence of XMLKEY
	...
	@Test
	void when_passing_a_package_with_XMLKEY_only_then_json_will_not_have_CHORD_LIST_GENERATOR_item() throws Exception {
		// because only the XMLKEY will have rendered. CHORD_PROGRESSION will not render due to absence of PHRASE_LENGTH
	...
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_2_and_XMLKEY_0_then_json_will_have_CHORD_LIST_GENERATOR_item() throws Exception {
		// all three will render
	...
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_2_and_XMLKEY_0_then_json_will_have_CHORD_LIST_GENERATOR_random_seed_item() throws Exception {
		// all three will render
	...
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_3_and_XMLKEY_0_then_json_CHORD_LIST_GENERATOR_random_seed_item_will_be_test_random_sequence_accomodating_the_no_repeat_rule() throws Exception {
		...
		assertThat(array).isEqualTo(Arrays.asList(new double[] {0.1, 0.7, 0.4}));	
	}
	
	
	@Test
	void when_passing_a_package_with_a_shorter_previous_PHRASE_LENGTH_then_json_CHORD_LIST_GENERATOR_random_seed_item_will_be_test_random_sequence_accomodating_the_no_repeat_rule() throws Exception {
		...
		pack.getJson().remove(Parameter.PHRASE_LENGTH.toString());
	...
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_2_and_XMLKEY_0_then_json_CHORD_LIST_GENERATOR_selected_options_will_have_indices_0_and_4() throws Exception {
		PooplinePackage pack = new PooplinePackage("x", new TestRandom(new double[] {0.05}));
		PooplinePlugin lengthPlug = new RandomPhraseLength();
		pack = lengthPlug.process(pack);
		...
		assertThat(array).isEqualTo(Arrays.asList(new int[] {0, 4}));		
	}
	
	
	@Test
	void when_passing_a_package_with_PHRASE_LENGTH_2_and_XMLKEY_0_then_json_CHORD_LIST_GENERATOR_selected_options_will_have_position_and_chords_0_C_1_G() throws Exception {
		PooplinePackage pack = new PooplinePackage("x", new TestRandom(new double[] {0.05}));
		PooplinePlugin lengthPlug = new RandomPhraseLength();
		pack = lengthPlug.process(pack);
		...
		assertThat(jsonObject.has("0.0")).isTrue();
		assertThat(jsonObject.has("1.0")).isTrue();
		assertThat(jsonObject.get("0.0").getAsString()).isEqualTo("C");
		assertThat(jsonObject.get("1.0").getAsString()).isEqualTo("G");
	}
	...
	void when_passing_a_package_with_PHRASE_LENGTH_2_and_XMLKEY_0_then_json_CHORD_LIST_GENERATOR_will_have_correct_plugin_class_name() throws Exception {
		...
		assertThat(plug.getClass().getName()).isEqualTo(jsonPlugInClassName);
	}
	...
	void when_passing_a_package_with_PHRASE_LENGTH_2_and_XMLKEY_0_then_json_CHORD_LIST_GENERATOR_will_have_options_item() throws Exception {
		...
		assertThat(chordListGeneratorJson.has("options")).isTrue();
	}
