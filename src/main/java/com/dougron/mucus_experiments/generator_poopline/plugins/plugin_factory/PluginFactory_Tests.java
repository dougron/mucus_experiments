...
//	TestCase tc = new TestCase(new XmlKeyRandom(), XmlKeyRepo.builder().className(XmlKeyRandom.class.getName()).build());
	...
	Object[][] testList = new Object[][] {
		...
		new Object[] {new DiatonicTriadProgressionRandom(), DiatonicTriadRepo.builder().className(DiatonicTriadProgressionRandom.class.getName()).build()},
		...
		new Object[] {new EvenlySpacedStructureToneFixed(1.0), EvenlySpacedStructureToneRepo.builder().className(EvenlySpacedStructureToneFixed.class.getName()).build()},
		...
		new Object[] {new PhraseBoundPercentRandom(Parameter.PHRASE_START_PERCENT), PhraseBoundRepo.builder().className(PhraseBoundPercentRandom.class.getName()).build()},
		new Object[] {new PhraseBoundPercentSetAmount(Parameter.PHRASE_START_PERCENT, 0.1), PhraseBoundRepo.builder().className(PhraseBoundPercentSetAmount.class.getName()).build()},
		...
		new Object[] {new TessituraFixed(Parameter.TESSITURA_MELODY_RANGE), TessituraRepo.builder().className(TessituraFixed.class.getName()).build()},
